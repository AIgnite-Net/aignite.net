...
// https://github.com/serilog-contrib/Serilog.Sinks.Logcat/blob/b515935d3622b5e11ba29fd41230929f9886ba1a/src/Serilog.Sinks.Logcat/LogcatConfigurationExtensions.cs
// And just modified to fit the style of this project.

using Serilog.Configuration;
using Serilog.Events;
using Serilog.Formatting;
using Serilog.Formatting.Display;
using Serilog.Sinks.Logcat;
...
/// </summary>
internal static class LogcatConfigurationExtensions
{
    const string DefaultConsoleOutputTemplate = "{Message:lj}{NewLine}{Exception}";
        ...
        IFormatProvider? formatProvider = null)
    {
        ...
        return sinkConfiguration.Sink(new LogcatSink(tag, formatter, restrictedToMinimumLevel));
    }
    ...
    /// will be able to lock on this object and guarantee that the console sink will not be about to output anything while
